...
Running the Astro project in this repo offers a minimal setup of the working plugin demonstrating `currentColor` working with dynamic color scheme css variables.
